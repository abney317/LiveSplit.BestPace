...
{
    public class BestPaceComponent : IComponent
    {
        ...
        public BestPaceComponent(LiveSplitState state)
        {
        ...
        public void Update(IInvalidator invalidator, LiveSplitState state, float width, float height, LayoutMode mode)
        {
            ...
            var bestPaceString = "";
            if (bestPace && InternalComponent.TimeValue != null)
            {
                bestPaceString = "Yes";
            }
            else if (!bestPace && InternalComponent.TimeValue != null)
            {
                bestPaceString = "No";
            }

            InternalComponent.InformationName = "Best Pace Ever? " + bestPaceString;
